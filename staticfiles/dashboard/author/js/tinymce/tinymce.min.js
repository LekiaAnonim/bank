...
!(function(V) {
  ...
  var he,
    ...
    it = function(e) {
      return (
        (1 !== e.nodeType && 9 !== e.nodeType) || 0 === e.childElementCount
      );
    },
    at = function(e, t) {
      return e.dom() === t.dom();
    ...
    bn = function(e, t, n) {
      ...
      if (((n = n || e), t)) {
        if (
          ...
          "static" === mn(Ne.fromDom(e), "position")
        )
          return {
            x: (a =
      ...
      : ((xn =
        ...
        (Sn.all = function() {
          var s = Array.prototype.slice.call(
            1 === arguments.length && xn(arguments[0])
              ? arguments[0]
              : arguments
          );
          ...
          if (2 !== a.status)
            if (3 !== a.status) {
              if (
                ...
                g.referrerPolicy &&
                  cn(Ne.fromDom(o), "referrerpolicy", g.referrerPolicy),
                "onload" in o &&
                  !(
                    (m = V.navigator.userAgent.match(/WebKit\/(\d*)/)) &&
                    parseInt(m[1], 10) < 536
                  ))
              )
                ...
                if (0 < V.navigator.userAgent.indexOf("Firefox"))
                  return (
                    ((r = p.createElement("style")).textContent =
                      '@import "' + e + '"'),
                    d(),
                    void b(r)
                  );
  ...
  function no(i) {
    ...
    i.valid_elements
      ...
      : (Yr(n, function(e, t) {
        ...
        Yr(Zr("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"), function(
          e
        ) {
          x[e].paddEmpty = !0;
        }),
  ...
  var hi = function(e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Io) !== To && Ro(t),
      (n = n || []),
      !e || "string" != typeof e)
    )
      return n;
  ...
  function vi() {
    ...
    function r(e, t) {
      return (
        n.push(e + " ") > bo.cacheLength && delete r[n.shift()],
        (r[e + " "] = t)
      );
    }
    return r;
    ...
    for (
      var r,
        ...
        l = [
          function(e, t, n) {
            return (
              (!i && (n || t !== Eo)) || ((r = t).nodeType ? s : c)(e, t, n)
            );
          }
        ];
      u < o;
  ...
  (yo = hi.support = {}),
    ...
    (hi.attr = function(e, t) {
      ...
      var n = bo.attrHandle[t.toLowerCase()],
        r =
          n && qo.call(bo.attrHandle, t.toLowerCase())
            ? n(e, t, !Do)
            : undefined;
      return r !== undefined
        ? r
      ...
      if (((n = n || []), 1 === l.length)) {
        ...
        for (
          ...
          if (
            (s = bo.find[u]) &&
            (r = s(
              a.matches[0].replace(pi, gi),
              (di.test(i[0].type) && wi(t.parentNode)) || t
            ))
          ) {
            if ((i.splice(o, 1), !(e = r.length && Si(i))))
              return Xo.apply(n, r), n;
            break;
          }
      }
      return (
        (c || So(e, l))(r, t, !Do, n, (di.test(e) && wi(t.parentNode)) || t), n
      );
    }),
    (yo.sortStable =
      Lo.split("")
  ...
  (Ki.fn = Ki.prototype = {
    ...
    add: function(e, t) {
      ...
      if (!1 !== t)
        for (
          n = na.unique(this.toArray().concat(na.makeArray(e))),
  ...
  var Zi = function(e, t, n) {
      var r = [],
        o = e[t];
      for (
        "string" != typeof n && n instanceof na && (n = n[0]);
        o && 9 !== o.nodeType;
  ...
  var Ra = _a,
    ...
    Ia = function(e) {
      0 === (Oa(e) ? e.dom().classList : Da(e, "class")).length &&
        dn(e, "class");
    },
    Ma = function(e, t) {
  ...
  var ja,
    ...
    vu = function(e) {
      ...
      return (
        !(!e || !Zt(t)) &&
        (t.data.charAt(e.offset()) === su ||
          (e.isAtStart() && pu(t.previousSibling)))
      );
    },
    yu = function(e) {
      var t = e.container();
      return (
        !(!e || !Zt(t)) &&
        (t.data.charAt(e.offset() - 1) === su ||
          (e.isAtEnd() && pu(t.nextSibling)))
      );
    },
    bu = function(e, t, n) {
      var r, o, i;
    ...
    Du = function(e) {
      return (
        !Au(e) && (ku(e) ? !_u(e.parentNode) : Ru(e) || Eu(e) || Tu(e) || Ou(e))
      );
    },
    Ou = function(e) {
      return (
        !1 === ($t((t = e)) && "true" === t.getAttribute("unselectable")) &&
        Nu(e)
      );
      var t;
    },
      ...
      var t,
        ...
        i = function(e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (
              qu(e.data[t - 1]) &&
              (n.setStart(e, t), n.setEnd(e, t + 1), !is(n))
            )
              return o(ss(us(n), !1)), r;
          }
          0 < t &&
            (n.setStart(e, t - 1), n.setEnd(e, t), is(n) || o(ss(us(n), !1))),
            t < e.data.length &&
              (n.setStart(e, t), n.setEnd(e, t + 1), is(n) || o(ss(us(n), !0)));
        };
  ...
  var fs,
          ...
          (r = cr(
            ...
            ? ps(r)
              ? (function(e, t) {
                  ...
                  return (
                    ps(e) && t > e.data.length && (t = e.data.length), ms(e, t)
                  );
                })(r, parseInt(o, 10))
    ...
    As = function(e, t) {
      ...
      if (gu(e)) {
        if (
          (Zt(e) && mu(e) && (e = e.parentNode), (n = e.previousSibling), Es(n))
        )
          return n;
    ...
    Ds = function(e, t, n) {
      ...
      var a,
        ...
        d,
        m =
          As((a = i).startContainer, a.startOffset) ||
          As(a.endContainer, a.endOffset);
      return m
    ...
    rc = function(e) {
      if (
        (Xs(e) &&
          gu(e) &&
          (hu(e) ? e.removeAttribute("data-mce-caret") : Gs(e)),
        Ys(e))
      ) {
        var t = lu(
          (function(e) {
      ...
      var n,
        ...
        f = function() {
          !(function(e) {
            var t, n, r, o, i;
            for (
              t = Ua(Ne.fromDom(e), "*[contentEditable=false]"), o = 0;
              o < t.length;
              o++
            )
        ...
        d = function() {
          n = Xn.setInterval(function() {
            t()
              ? na("div.mce-visual-caret", a).toggleClass(
                  "mce-visual-caret-hidden"
                )
              : na("div.mce-visual-caret", a).addClass(
                  "mce-visual-caret-hidden"
                );
          }, 500);
        };
          ...
          if (!u(e))
            return (
              (s = (function(e, t) {
                var n, r, o;
                if (
                  ((r = e.ownerDocument.createTextNode(su)),
                  (o = e.parentNode),
                  t)
                ) {
  ...
  var Dc,
    ...
    Wc = function(e, t, n) {
      return e
        ? !$c(t, n) &&
            ((r = t), !(!ms.isTextPosition(r) && rn(r.getNode()))) &&
            qc(t) &&
            Vc(n)
        : !$c(n, t) && Vc(t) && qc(n);
      var r;
    ...
    Ul = function(e, t, n, r) {
      ...
      return (
        (n[0].inline || n[0].block_expand) &&
          ...
          (n[0].inline && Zt(a) && u !== a.nodeValue.length) ||
            (a = Fl(s, n, o, i, a, u, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((o = Il(s, n, t, o, "previousSibling")),
          ...
          V = function(e, t, n, r, o) {
            ...
            if (
              ...
              v &&
                !g &&
                !1 ==
                  (0 === (s = t).indexOf("data-") || 0 === s.indexOf("aria-")))
            ) {
              if (!(i = b[t]) && C) {
  ...
  var wf,
    ...
    Ff = function(e) {
      return (
        an(e) && !($t((t = e)) && "all" === t.getAttribute("data-mce-bogus"))
      );
      var t;
    },
    Uf = If(!0, Mf),
    ...
    id = function(e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === ms.isTextPosition(n) &&
        o === r.parentNode &&
        i > ms.before(r).offset()
    ...
    ad = function(e) {
      return Du(e.previousSibling)
        ? R.some(
            ((t = e.previousSibling),
            Zt(t) ? ms(t, t.data.length) : ms.after(t))
          )
        : e.previousSibling
    ...
    Td = function(n) {
      return $u(
        _d((r = n).cells, r.rng.start),
        _d(r.cells, r.rng.end),
        function(e, t) {
    ...
    Bd = function(e, t, n) {
      ...
      if (
        (Gf(i) && (Qf(i), e.selection.setCursorLocation(i.dom(), 0)), !at(n, i))
      ) {
        var a = ft(i).is(n)
          ? []
          : ft((r = i))
    ...
    Wd = function(e, t) {
      ...
      return (
        ...
        (r = t).firstChild && r.firstChild === r.lastChild &&
    ...
    Yd = function(e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || Xd(t))
        ? e.slice(0, -1)
        : e;
      var t;
    },
    ...
    nm = function(e) {
      ...
      (r = t),
        (o = n),
        null !== (i = a) &&
        i === r.getParent(o.endContainer, em) &&
        Xl(Ne.fromDom(i), o)
          ? Bd(e, n, Ne.fromDom(a))
    ...
    rm = function(e, t, n) {
      ...
      if (
        ...
        x === S &&
          ...
          ((l = g.createRng()).setStart(S.firstChild, 0),
        ...
        if (
          ((u = r.parse(t, _)), !0 === n.paste && Kd(e.schema, u) && Gd(g, i))
        )
          return (
    ...
    Tm = function(t, e) {
      return ((n = e).collapsed
        ? R.from(Hu(n.startContainer, n.startOffset)).map(Ne.fromDom)
        : R.none()
      ).bind(function(e) {
        ...
        if ("undefined" == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              if (
                ((u = "attributes" === r ? e.getAttrib(t, a) : Sl(e, t, a)),
                o && !u && !n.exact)
              )
                return;
    ...
    Gm = function(e, t, n, r) {
      ...
      return r
        ...
        : ((r = e.selection.getNode()),
          !!Wm(e, r, t, n) ||
            !((o = e.selection.getStart()) === r || !Wm(e, o, t, n)));
    },
    Jm = function(r, o, i) {
      var a = [],
        u = {},
    ...
    Qm = function(e, t) {
      ...
      if (u)
        for (
          n = e.selection.getStart(), r = El(s, n), i = u.length - 1;
          0 <= i;
          i--
        ) {
    ...
    ip = function(e, t, n) {
      ...
      if (np(t)) gd(e, !1, Ne.fromDom(t), n);
        ...
        var a = i.getRng(),
          ...
          f = a.endOffset,
          d =
            ((r = rp(t)) && r.nodeValue.charAt(0) === ep && r.deleteData(0, 1),
            r);
        o.remove(t, !0),
        ...
        if (o) {
          ...
          var x = (function(t, e, n, r, o, i) {
              ...
              if (
                ...
                var l = n.cloneNode(!1);
                return (
                  u.add(e, l), a.remove(r, o, l, i), u.remove(l), R.some(l)
                );
              }
              return R.none();
            })(e, w, a, t, n, r),
    ...
    fp = function(e, t) {
      return (
        e.schema.getTextInlineElements().hasOwnProperty(Rt(t)) &&
        !Ms(t.dom()) &&
        !Yt(t.dom())
      );
    },
  ...
  var gp,
      ...
      if ("all" !== r.remove) {
        yp(r.styles, function(e, t) {
          (e = xl(l, Cl(e, o), t)),
            ...
            (!r.remove_similar && i && !bp(Sl(l, i, t), e)) ||
              l.setStyle(y, t, ""),
            (n = !0);
        }),
          n &&
    ...
    kp = function(s, c, l, e, f) {
      ...
      if (e)
        ...
        for (
          var o = 0;
          o < d.length && (!d[o].ceFalseOverride || !Ep(s, d[o], l, e, e));
          o++
        );
      }
    },
                ...
                u = function(e) {
                  ...
                  if (O.wrapper && Ym(R, e, T, A)) a = 0;
                    ...
                    if (
                      ...
                      return (
                        (e = k.rename(e, c)), B(e), _.push(e), void (a = 0)
                      );
                    if (O.selector) {
                      var i = d(D, e);
              ...
              (!(1 < _.length) && k.isBlock(e)) || 0 !== t)
                ? (O.inline || O.wrapper) &&
                  ...
                  ("sub" !== (u = O).inline && "sup" !== u.inline) ||
                    ...
                    a.remove(
                      a.select("sup" === u.inline ? "sub" : "sup", s),
                      !0
                    )),
                  (r = k),
                  (o = O),
    ...
    lg = function(e, t) {
      return (
        !(!e || !t) && ((r = t), sg(e) === sg(r) || ((n = t), cg(e) === cg(n)))
      );
      var n, r;
    },
    fg = function(e) {
      ...
      return {
        undoManager: {
          beforeChange: function(e, t) {
            return (
              (n = s), (r = t), void (fg(e) && r.set(R.some(Ls(n.selection))))
            );
            var n, r;
          },
          ...
          transact: function(e, t, n) {
            return (
              (o = n), mg((r = e), t), r.beforeChange(), r.ignore(o), r.add()
            );
            var r, o;
          },
          ignore: function(e, t) {
        ...
        formatter: {
          ...
          toggle: function(e, t, n) {
            return (
              ...
              void (!Gm(r, o, i, a) || ("toggle" in u[0] && !u[0].toggle)
                ? Mp
                : kp)(r, o, i, a)
            );
            var r, o, i, a, u;
    ...
    kg = function(e) {
      if (!e.removed) {
        ...
        r && e.save({ is_removing: !0 }),
          ...
          !e.inline &&
            r &&
            ((i = e), Ng.setStyle(i.id, "display", i.orgDisplay)),
          e.fire("detach"),
            ...
            : {}),
          {
            ...
            external_plugins:
              ...
              s && s.external_plugins
                ? hr.extend({}, s.external_plugins, l)
                : l)
          }
        );
      return zg(e, m, r, p);
    ...
    Qg = function(e, t, n) {
      var r,
        ...
        g = e.inline
          ? p
          : ((r = p), Ne.fromDom(r.dom().ownerDocument.documentElement)),
        h =
          ((o = e.inline),
          (a = t),
          (u = n),
  ...
  var rh = function(n) {
    ...
    ch = function(e) {
      ...
      r &&
        (r.error ? r.error.apply(r, ge([e], t)) : r.log.apply(r, ge([e], t)));
    },
    lh = function(t) {
      var e,
        n,
  ...
  var fh = (function hE(r, o) {
      ...
      return {
        set: function(e, t) {
          if (!O(t) && !t.match(/^[0-9]+$/))
            throw new Error(
              r + ".set accepts only positive INT values. Value was " + t
            );
          var n = e.dom();
          un(n) && (n.style[r] = t + "px");
        },
    ...
    kh = function(e, t, n, r) {
      ...
      i.top() < a.y
        ? zt(n.element, !1 !== r)
        : i.top() > a.bottom && zt(n.element, !0 === r);
    },
    _h = function(e, t, n) {
      return yh(e, Eh, t, n);
    },
    ...
    qh = function(e, t, n, r, o) {
      ...
      for (var l, f, d = new ra(o, c); (a = d[r ? "prev" : "next"]()); ) {
        ...
        if (Zt(a) && 0 < a.nodeValue.length)
          return !1 === jh(a, u, "A")
            ? R.some(ls(a, r ? a.nodeValue.length : 0))
            : R.none();
    ...
    $h = function(e, t, n, r) {
      ...
      if (
        ...
        return R.none();
      if (
        ($t(o) && i > o.childNodes.length - 1 && (s = !1),
        tn(o) && ((o = m), (i = 0)),
        o === m)
      ) {
      ...
      if (
        ...
        n.content = (function(e, t) {
          ...
          var n = e.parser.parse(
            t.content,
            pe({ isRootContent: !0, forced_root_block: !1 }, t)
          );
      ...
      var D = function(e) {
        ...
        L = function(e) {
          ...
          (t = e.screenX - m),
            ...
            d[2] < 0 &&
              l.clientWidth <= w &&
              E.setStyle(l, "left", g + (v - w)),
            d[3] < 0 &&
              l.clientHeight <= x &&
              E.setStyle(l, "top", h + (y - x)),
                  ...
                  (t = E.get("mceResizeHandle" + e)) && E.remove(t),
                    ...
                    E.bind(t, "mousedown", function(e) {
                      ...
                      e.stopImmediatePropagation(),
                        ...
                        E.bind(k, "mouseup", I),
                        _ !== k &&
                          (E.bind(_, "mousemove", L), E.bind(_, "mouseup", I)),
                        (f = E.add(
                          A,
                          "div",
                          {
  ...
  var ov = function(e) {
    ...
    iv = function(e) {
      return (
        !(!e || !e.ownerDocument) &&
        st(Ne.fromDom(e.ownerDocument), Ne.fromDom(e))
      );
    },
    av = function(u, s, e, c) {
      var n,
        ...
        m = function() {
          ...
          return (
            (t =
              (t = Fp(c, [t])[0]) ||
              (r.createRange ? r.createRange() : r.body.createTextRange()))
              .setStart &&
        ...
        a = function(e, t) {
          ...
          if (
            (o = e) &&
            (ov(o) || (iv(o.startContainer) && iv(o.endContainer)))
          ) {
            var o,
              i = ov(e) ? e : null;
            if (i) {
        ...
        g = {
          ...
          setCursorLocation: function(e, t) {
            var n = u.createRng();
            e
              ? (n.setStart(e, t), n.setEnd(e, t), a(n), i(!1))
              : (Yl(u, n, c.getBody(), !0), a(n));
          },
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType &&
                    3 === o.nodeType &&
                    ((r =
                      r.length === i ? Mh(r.nextSibling, !0) : r.parentNode),
    ...
    sv = function(e, t) {
      ...
      t.convert_fonts_to_spans &&
        uv(e, r, hr.explode(t.font_size_legacy_values)),
        (n = r),
            ...
            t = kf(
              {
                ...
                start: function(e, t, n) {
                  ...
                  if ((n = v ? T.getElementRule(e) : {})) {
                    ...
                    if (
                      (f && C[e] && (f = !1), n.removeEmpty && yv(T, g, C, d))
                    )
                      return (
                        (i = d.parent),
                    ...
                    n.paddEmpty &&
                      ((vv((a = d), "#text") && a.firstChild.value === oo) ||
                        yv(T, g, C, d)) &&
                      hv(R, u, l, d),
                      (d = d.parent);
                  }
                    ...
                    for (; n; )
                      (e = n.next),
                        ...
                        (1 === n.type &&
                          ...
                          ? (t ||
                              ((t = E(b, 1)).attr(R.forced_root_block_attrs),
                              _.insert(t, n)),
                            t.append(n))
                          : (r(t), (t = null)),
                        (n = e);
              ...
              for (r = 0, o = D.length; r < o; r++)
                if ((s = D[r]).name in B) {
                  for (i = (n = B[s.name]).length; i--; )
                    n[i].parent || n.splice(i, 1);
                  for (i = 0, a = s.callbacks.length; i < a; i++)
                      ...
                      return (
                        ...
                        u.getParam("images_replace_blob_uris", !0, "boolean")
                          ...
                          : e.error &&
                            ...
                            ih(
                              n,
                              ka.translate(["Failed to upload image: {0}", r])
                            )),
                        {
                          element: i,
                          status: e.status,
  ...
  var Uv,
    ...
    Xv = function(s) {
      var e,
        ...
        d = {
          ...
          transact: function(e) {
            return (
              (t = d), (n = l), (r = e), wg(s).undoManager.transact(t, n, r)
            );
            var t, n, r;
          },
          ignore: function(e) {
    ...
    Zv = function(a) {
      var e,
        ...
        c = (e = a).getParam(
          "placeholder",
          Us.getAttrib(e.getElement(), "placeholder"),
          "string"
        ),
        l = function(e, t) {
          if (
            ...
            var n,
              ...
              i =
                !(
                  Jv((n = e)) &&
                  !(Qv(n) || ("keyup" === n.type && 229 === n.keyCode))
                ) &&
                (function(e, t, n) {
              ...
              ey(e).each(function(i) {
                u.get().each(function(e) {
                  ...
                  (t = i),
                    ...
                    (5 < r || 5 < o) &&
                      (u.set(R.none()), s.set(!1), a.fire("longpresscancel"));
                });
              });
          },
          !0
    ...
    ry = function(e, t) {
      if (Zt(t)) {
        ...
        if (
          /^\s+$/.test(t.nodeValue) &&
          (!t.nextSibling || ny(e, t.nextSibling))
        )
          return !0;
      }
      return !1;
    ...
    fy = function(e, t) {
      return (e
        ...
        : function(e) {
            if (uy(e.nextSibling))
              return (
                sy(e.nextSibling) || e.nextSibling.insertData(0, su),
                e.nextSibling
              );
    ...
    by = function(e) {
      return (
        "rtl" === ga.DOM.getStyle(e, "direction", !0) ||
        ((t = e.textContent), vy.test(t))
      );
      var t;
    },
    Cy = function(e, t, n) {
    ...
    nb = function(o, i, a, e, u, t) {
      var n,
        ...
        r = function(e) {
          var t, n, r;
          for (
            r = Zy([e]), -1 === o && (r = r.reverse()), t = 0;
            t < r.length;
            t++
          )
            if (((n = r[t]), !a(n, s))) {
              if ((0 < l.length && i(n, fr(l)) && c++, (n.line = c), u(n)))
                return !0;
              l.push(n);
            }
        };
  ...
  var wb = function(e, t) {
    ...
    xb = function(e, t, n, r) {
      for (
        ...
        f &&
        ((s = l), (c = f), (o = t === fs.Forwards ? s.next(c) : s.prev(c)));
      ...
      return W(
        ...
        function(e, o) {
          return e.fold(
            ...
            function(r) {
              return $u(Z(r.getClientRects()), Z(o.getClientRects()), function(
                e,
                t
              ) {
    ...
    Mb = function(r, o) {
      return function() {
        var t,
          e = o
            ? ms.fromRangeEnd(r.selection.getRng())
            : ms.fromRangeStart(r.selection.getRng()),
    ...
    $b = function(e, t, n) {
      ...
      return ((a = u).breakType === eb.Wrap && 0 === a.positions.length) ||
        (!rn(n.getNode()) &&
          (i = u).breakType === eb.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
          !u.breakAt
            .map(function(e) {
      ...
      return $u(t, n, mC).filter(function(e) {
        return (
          ...
          ft((n = e).from.block)
            ...
            .isSome() &&
          !1 === an((t = e).from.block.dom()) && !1 === an(t.to.block.dom())
        );
        var t, n, r;
      });
    },
    ...
    xC = function(e, t, n) {
      return (
        wC(!0, t), wC(!1, n), CC(t, n).fold(N(bC, e, t, n), N(yC, e, t, n))
      );
    },
    SC = function(e, t, n, r) {
    ...
    NC = function(t, n) {
      var e,
        ...
        a =
          ((e = i.dom()),
          (r = n),
          ((o = t.selection.getRng()).collapsed ? gC(e, r, o) : R.none()).bind(
            function(e) {
    ...
    kC = function(e, t) {
      ...
      return (
        !(EC((n = e), (r = t).startContainer) || EC(n, r.endContainer)) &&
        o &&
        i
      );
    },
    ...
    XC = function(r, o, i, a) {
      ...
      r.undoManager.ignore(function() {
        ...
        r.selection.setRng(
          ...
          Py(s, u, ms.fromRangeStart(r.selection.getRng()))
            .map(Fy)
            .map(KC(r, o));
      }),
        r.nodeChanged();
          ...
          /^(LI|DT|DD)$/.test(f) && g.isEmpty(c)
            ...
            : (m && c === a.getBody()) ||
              ...
              mu(c)
                ...
                ? w()
                : C(!0)
                ? ((r = c.parentNode.insertBefore(b(), c)),
                  yw(a, kw(c, "HR") ? r : c))
                : ((_ = (k = y).cloneRange()).setStart(
                  ...
                  (S = c).normalize(),
                  ((N = S.lastChild) &&
                    !/^(left|right)$/gi.test(x.getStyle(N, "float", !0))) ||
                    x.add(S, "br"),
                  g.isEmpty(c) && Ew(c),
                  r.normalize(),
    ...
    Lw = function(e, t) {
      ...
      "LI" !== d || m || (l = f),
        s &&
          ...
          !(function(e, t, n) {
            for (
              var r, o = new ra(t, n), i = e.getNonEmptyElements();
              (r = o.next());
    ...
    px = function(e, t) {
      return (
        (n = e),
        (!fx((r = t)) && (dw(n, r) || pw(n, r) || OC(n, r) || cx(n, r))) ||
          mx(e, t)
      );
      var n, r;
    },
    ...
    xx = function(r) {
      r.on("keydown", function(e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          cC([{ keyCode: Zh.SPACEBAR, action: sC(wx, t) }], n).each(function(
            e
          ) {
            n.preventDefault();
          }));
    ...
    Nx = function(e, t) {
      var n,
        r =
          ((n = e),
          $a(Ne.fromDom(n.getBody()), "*[data-mce-caret]").fold(
            x(null),
            function(e) {
              return e.dom();
            }
  ...
  var Dx = function(e) {
    ...
    zx = function(g, h) {
      ...
      return function(e) {
        ...
        if (g.dragging) {
          var p =
            ((f = g),
            { pageX: (d = Lx(h, e)).pageX - f.relX, pageY: d.pageY + 5 });
          (c = g.ghost),
            (l = h.getBody()),
        ...
        (n = e).on("drop", function(e) {
          var t =
            "undefined" != typeof e.clientX
              ...
              : null;
          (Ix(t) || Ix(n.dom.getContentEditableParent(t))) &&
            e.preventDefault();
        });
    },
    $x = on,
          ...
          })(),
        {
          ...
          showBlockCaretContainer: function(e) {
            e.hasAttribute("data-mce-caret") &&
              (xu(e), a(r()), g.selection.scrollIntoView(e));
          },
          hideFakeCaret: w,
          destroy: function() {
            o.destroy(), (h = null);
          ...
          pe(
            ...
            Jx({
              ...
              move_caret_before_on_enter_elements:
                i.move_caret_before_on_enter_elements,
    ...
    lS = function(e) {
      ...
      return e.inline
        ? cS(null)
        : ((t = r), (n = aS.create("div")), aS.insertAfter(n, t), cS(n));
    },
    fS = function(e) {
      var n, t, r, o, i, a;
          ...
          if (q(t)) {
            ...
            (e.theme = new n(e, nh.urls[t])),
              e.theme.init &&
                e.theme.init(
                  e,
                  nh.urls[t] || e.documentBaseUrl.replace(/\/$/, ""),
                  e.$
                );
          } else e.theme = {};
        })(e),
          ...
          q(u.settings.theme)
            ...
            ? ((c = (s = u).getElement()),
              (l = (0, s.settings.theme)(s, c)).editorContainer.nodeType &&
                (l.editorContainer.id =
                  l.editorContainer.id || s.id + "_parent"),
              l.iframeContainer &&
                l.iframeContainer.nodeType &&
                (l.iframeContainer.id =
                  l.iframeContainer.id || s.id + "_iframecontainer"),
      ...
      (LS.prototype.setupCommands = function(i) {
        ...
        this.addCommands({
          ...
          FontSize: function(e, t, n) {
            var r, o;
            (o = n),
              (r = i).formatter.toggle("fontsize", { value: TS(r, o) }),
              r.nodeChanged();
          },
    ...
    MS =
      ...
      (FS.prototype.on = function(e, t, n, r) {
        ...
        if ((!1 === t && (t = g), t)) {
          var u = { func: t };
          for (
            r && hr.extend(u, r), a = (i = e.toLowerCase().split(" ")).length;
            a--;
  ...
  var US,
    ...
    GS = function(e, t) {
      return "selectionchange" === t
        ...
        ? (e.eventRoot || (e.eventRoot = YS.select(e.settings.event_root)[0]),
          e.eventRoot)
        : e.getBody();
    },
    JS = function(e, t, n) {
      ...
      toggleNativeEvent: function(e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(GS(n, e), e, n.delegates[e]),
    ...
    uN =
      ...
      (sN.prototype.createShortcut = function(e, t, n, r) {
        var o;
        return (
          ((o = hr.map(oN(e, ">"), this.parseShortcut))[
            o.length - 1
          ] = hr.extend(o[o.length - 1], { func: n, scope: r || this.editor })),
          hr.extend(o[0], {
        ...
        return (
          0 !==
            (o =
              (n = u.length - i) <= 0
                ? J(a).join("/")
                : u.slice(0, n).join("/") + "/" + J(a).join("/")).indexOf(
              "/"
            ) && (o = "/" + o),
  ...
  var hN = ga.DOM,
    ...
    wN =
            ...
            if (t.getElement() && rr.contentEditable) {
              ...
              o &&
                ...
                e.hidden_input &&
                  !Qt(t.getElement()) &&
                  (dS.insertAfter(
                    dS.create("input", { type: "hidden", name: n }),
                    n
                  ),
                  (t.hasHiddenInput = !0)),
      ...
      (xN.prototype.resetContent = function(e) {
        e === undefined
          ? Sg(this, this.startContent, { format: "raw" })
          : Sg(this, e),
      ...
      (xN.prototype.getElement = function() {
        return (
          this.targetElm || (this.targetElm = hN.get(this.id)), this.targetElm
        );
      }),
  ...
  function xN(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        ...
        ga.DOM.styleSheetLoader._setReferrerPolicy(
          this.settings.referrer_policy
        )),
  ...
  var SN,
    ...
    PN = function(e) {
      e !== AN &&
        (e
          ? na(window).on("resize scroll", BN)
          : na(window).off("resize scroll", BN),
        (AN = e));
    },
    LN = function(t) {
      var e = ON;
      ...
      return (
        ...
        MN.activeEditor === t &&
          (MN.activeEditor = 0 < ON.length ? ON[0] : null),
    ...
    MN = pe(pe({}, jS), {
              ...
              r.types
                ? _N(r.types, function(t) {
                    hr.each(o, function(e) {
                      return (
                        !EN.is(e, t.selector) || (n(c(e), RN({}, r, t), e), !1)
                      );
                    });
                  })
                : (hr.each(o, function(e) {
      ...
      add: function(e) {
        ...
        return (
          DN[e.id] === e ||
            (null === n.get(e.id) &&
              ("length" !== e.id && (DN[e.id] = e), DN.push(e), ON.push(e)),
            PN(!0),
            (n.activeEditor = e),
            ...
            return (
              ...
              _(r.get(n.id))
                ...
                : (LN(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === ON.length &&
                    window.removeEventListener("beforeunload", SN),
                  n.remove(),
                  PN(0 < ON.length),
                  n)
            );
      ...
      _setBaseUrl: function(e) {
        (this.baseURL = new pN(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new pN(this.baseURL));
      }
  ...
  var UN,
    ...
    qN =
      ...
      (zN = {}),
      {
        ...
        add: function(e, t) {
          zN[e] !== undefined && (zN[e](t), delete zN[e]),
            (UN[e] = Mn.resolve(t));
        }
      }),
    $N = Math.min,
      ...
      send: function(e) {
        ...
        if (
          ...
          if (
            ...
            (t = iE.fire("beforeSend", { xhr: t, settings: e }).xhr).send(
              e.data
            ),
            !e.async)
          )
