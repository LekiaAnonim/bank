 ...
 *   https://datatables.net/download/#dt/dt-1.10.24/fc-3.3.2/r-2.2.7
 *
 * Included libraries:
 *   DataTables 1.10.24, FixedColumns 3.3.2, Responsive 2.2.7
 */
...
(function(k) {
  ...
  u.ext = L = {
    buttons: {},
    classes: {},
    build: "dt/dt-1.10.24/fc-3.3.2/r-2.2.7",
    errMode: "alert",
    feature: [],
    search: [],
...
$jscomp.polyfill = function(c, h, k, t) {
  h &&
    ($jscomp.ISOLATE_POLYFILLS
      ? $jscomp.polyfillIsolated(c, h, k, t)
      : $jscomp.polyfillUnisolated(c, h, k, t));
};
  ...
  c.extend(u.prototype, {
    ...
    _fnConstruct: function(a) {
      ...
      if (
        ...
        var e =
          "onwheel" in k.createElement("div")
            ? "wheel.DTFC"
            : "mousewheel.DTFC";
        0 < b.s.iLeftColumns &&
        ...
        m.on("draw.dt.DTFC", function() {
          ...
          .on("position.dts.dt.DTFC", function(g, q) {
            b.dom.grid.left.body &&
              c(b.dom.grid.left.body)
                .find("table")
                .eq(0)
                .css("top", q);
            b.dom.grid.right.body &&
              c(b.dom.grid.right.body)
                .find("table")
                .eq(0)
                .css("top", q);
          })
      ...
      c.each(this.s.dt.aoColumns, function(f, e) {
        ...
        if (e.filter(":visible").length) {
          ...
          if (0 === a.s.aiOuterWidths.length) {
            ...
            l +=
              "string" === typeof m && -1 === m.indexOf("px")
                ? 1
                : parseInt(m, 10);
          }
          a.s.aiOuterWidths.length === a.s.dt.aoColumns.length - 1 &&
            ((m = c(a.s.dt.nTable).css("border-right-width")),
            (l +=
              "string" === typeof m && -1 === m.indexOf("px")
                ? 1
                : parseInt(m, 10)));
    ...
    _fnCloneRight: function(a) {
      if (!(0 >= this.s.iRightColumns)) {
        ...
        for (
          ...
          this.s.dt.aoColumns[b].bVisible && d.push(b);
      ...
      for (var f = [], e = [], l = [], m = 0, g = a.length; m < g; m++) {
        ...
        for (var p = 0, r = this.s.iTableColumns; p < r; p++)
          if (-1 !== c.inArray(p, b)) {
            ...
            -1 === w
              ? ((w = c(a[m][p].cell).clone(d, !1)[0]),
                e.push(w),
                l.push(a[m][p].cell),
                q.push({ cell: w, unique: a[m][p].unique }))
    ...
    _fnClone: function(a, b, d, f) {
      ...
      "auto" == this.s.sHeightMatch &&
        c(">tbody>tr", e.dom.body).css("height", "auto");
        ...
        c(">tbody>tr", e.dom.body).each(function(y) {
          y =
            !1 === e.s.dt.oFeatures.bServerSide
              ? e.s.dt.aiDisplay[e.s.dt._iDisplayStart + y]
              : y;
          ...
          for (m = 0; m < d.length; m++)
            (A = d[m]),
              0 < D.length &&
                ...
                v.setAttribute("data-dt-row", y),
                v.setAttribute("data-dt-column", A),
                B.appendChild(v));
          C.appendChild(B);
        });
      } else
      ...
      g.oScroller !== t &&
        ((l = g.oScroller.dom.force),
        b.forcer
          ? (b.forcer.style.height = l.style.height)
          : ((b.forcer = l.cloneNode(!0)), b.liner.appendChild(b.forcer)));
      ...
      if (null !== g.nTFoot) {
        if (f) {
          ...
          for (
            q = this._fnCopyLayout(g.aoFooter, d, !1),
              b = [],
              g.oApi._fnDetectHeader(b, c(">tfoot", a.footer)[0]),
              r = 0,
              l = q.length;
            r < l;
            r++
          )
            for (x = 0, p = q[r].length; x < p; x++)
              b[r][x].cell.className = q[r][x].cell.className;
    ...
    _fnGetTrNodes: function(a) {
      for (var b = [], d = 0, f = a.childNodes.length; d < f; d++)
        "TR" == a.childNodes[d].nodeName.toUpperCase() &&
          b.push(a.childNodes[d]);
      return b;
    },
    _fnEqualiseHeights: function(a, b, d) {
      if ("none" != this.s.sHeightMatch || "thead" === a || "tfoot" === a) {
        ...
        d = 0;
        for (a = b.length; d < a; d++)
          (b[d].style.height = e[d] + "px"), (f[d].style.height = e[d] + "px");
      }
    },
      ...
      return this.iterator(
        ...
        function(a, b, d) {
          return a._oFixedColumns
            ? a._oFixedColumns.fnToFixedNode(b, d)
            : this.cell(b, d).node();
        },
        1
      );
